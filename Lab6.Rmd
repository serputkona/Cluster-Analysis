...
```
подібність двох кластерів визначається макс відстань між двома точками, що належать кластерам
...
обч суму квадратів відстаней між хі, хj
```{r}
...
```
У методі середньогго силету оптимальною кількістю кластерів є така, що максимізує середнє
значення силуету, а отже знову точка 2.
...
```
Всі три емтоди дали однаковий результат - 2, отже робимо висновок що оптимальна кількість
кластерів все ж 2.
